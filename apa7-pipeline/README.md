...
│   └── references_validated.json  # Metadados CrossRef
├── prompts/
...
- Citações autor–ano; 3+ autores → `et al.` (APA 7)
...
Artigo gerado: *Reações adversas na doação de sangue e o papel da enfermagem: revisão narrativa da evidência recente*  
